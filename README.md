...
. ├── README.md ├── evaluate_and_visualize.py # Model evaluation & visualization script ├── hyperband_tuner.py # Hyperparameter tuning (KerasTuner) ├── model_define_train.py # U-Net model definition and training logic ├── setup_and_load.py # Data preparation/util scripts ├── ss.py # Streamlit app for interactive demo ├── 
⚙️ Requirements
Software
...
oil_spill_dataset/ ├── train/ │ ├── images/ : input images │ └── masks/ : binary segmentation masks
...
ss.py	Main script to launch the interactive Streamlit web application.
